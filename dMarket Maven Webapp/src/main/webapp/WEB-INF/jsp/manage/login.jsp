...
<head>
	...
	<script type="text/javascript" src="hui/js/jquery.form.js"></script>
					...
					<div class="login_form">
						<form action="adminLogin" id="login_form" method="post">
							<div class="form-group">
								...
								<input id="userName" value="" name="name" type="text" class="form-control x319 in" autocomplete="off">
							</div>
							<div class="form-group">
								<label for="password" class="t">密 码:
								</label> <input id="password" value="" name="password" type="password" class="password form-control x319 in">
							</div>
