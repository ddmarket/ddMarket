...
.content {width ="1349px";height ="475px"
...
<body>
	...
	<div class="container" style="background-color: #F94747">
		<div class="row">
			<div class="col-xs-6 col-sm-1" style="background-color: #F94747">
				<br>
			</div>
			...
			<div class="col-xs-6 col-sm-4" style="background-color: #F94747">
				<div style="background-color: #ffffff">
					<div style="background-color: #F94747">
						<br>
					</div>
					<div style="background-color: #F94747">
						<br>
					...
					<!-- 登录表单 -->
					<form id="formLogin" class="form-signin" action="login"
						method="post">
						<h2 class="text-center text-danger">叮咚会员</h2>
						<br> <input type="text" name="userName" class="form-control"
							placeholder="用户名/手机/邮箱" required autofocus> <input
						...
						<div>
							<button type="submit"
								class="btn btn-lg btn-primary btn-block btn-danger">登录</button>
						</div>

						<h5 class="text-right">
							<a href="register.html">木有账号？赶紧注册</a>
						</h5>
